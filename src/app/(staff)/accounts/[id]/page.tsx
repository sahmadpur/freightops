...
import { archiveAccount, restoreAccount } from "@/modules/accounts/actions";
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-3">
            ...
            {account.deletedAt ? (
              <ArchiveButton mode="restore" label={t("actions.restore")} action={restoreAccount.bind(null, account.id)} />
            ) : (
              <ArchiveButton
                mode="archive"
